...
# All credits go to matthewbadeau https://github.com/matthewbadeau/7-Color-E-paper-Image-converter. I've just modified it a bit for using it with 6 color displays
...
def convert(image, orientation="portrait", width=480, height=800, crop_image=False, crop_x1=0, crop_y1=0, crop_x2=480,
    ...
    try:
        ...
        image = ImageEnhance.Contrast(img).enhance(1.2)
        image = ImageEnhance.Brightness(img).enhance(1.1)
        image = ImageEnhance.Color(img).enhance(1.5)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(prog="Image converter to 6-Color e-paper BMP",
                                     description="Converts full color images to BMP images that can "
                                                 "be used on a 6 color e-paper display."
